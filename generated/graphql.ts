...
export type ResolversTypes = ResolversObject<{
  ...
  Edge: ResolverTypeWrapper<Omit<Edge, 'node'> & { node?: Maybe<ResolversTypes['Link']> }>;
  Int: ResolverTypeWrapper<Scalars['Int']>;
  Link: ResolverTypeWrapper<LinkModel>;
  Mutation: ResolverTypeWrapper<{}>;
  PageInfo: ResolverTypeWrapper<PageInfo>;
  Query: ResolverTypeWrapper<{}>;
  Response: ResolverTypeWrapper<Omit<Response, 'edges'> & { edges?: Maybe<Array<Maybe<ResolversTypes['Edge']>>> }>;
  Role: Role;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  PageInfo: PageInfo;
  Query: {};
  Response: Omit<Response, 'edges'> & { edges?: Maybe<Array<Maybe<ResolversParentTypes['Edge']>>> };
